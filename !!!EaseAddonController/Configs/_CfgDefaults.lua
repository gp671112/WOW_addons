...
D["AngryAssignments"] = {
	...
	tags = { "BOSSRAID" },
	title = "記事本/團隊工作分配",
	desc = "遊戲內的隨手筆記本，方便拿來記錄魔獸大小事。可在遊戲進行的同時，將記事內容顯示在畫面上同步觀看。``團隊隊長和助理還可以將筆記內容傳送給隊友，作為打團時的工作分配和重點提示 (當隊友也有安裝並載入這個插件時)，或是輸出到聊天頻道，讓沒有安裝插件的隊友也能看到。``個人札記和打團都好用!!`",
	modifier = "彩虹ui",
...
D["AzeriteTooltip"] = {
	...
	tags = { "ITEM" },
	title = "艾澤萊特長提示",
	desc = "在艾澤拉斯之心強化裝備的滑鼠提示中顯示艾澤萊晶岩之力的特長和詳細說明。`",
...
D["Combuctor"] = {
	...
	{
		type = "text",
        text = "|cffFF2D2DDJ 智能分類背包和分類整合背包選擇其中一種使用即可，請勿同時載入。|r\n",
	},
	{
		type = "text",
...
--]]
	{
		type = "text",
        text = "|cffFF2D2DDJ智能分類背包和分類整合背包選擇其中一種使用即可，請勿同時載入。|r\n",
	},
	{
        type = "text",
...
D["DugisGuideViewerZ"] = {
	defaultEnable = 0,
	title = "Dugi 任務高手",
	desc = "提供類似衛星導航的箭頭，帶你做任務和升級!``開始導航：點畫面右方任務目標清單中，任務標題左方的數字 (或問號) 圓圈，開始導航這個任務。``如果導航沒有出現，請先打開世界地圖再點任務標題左方的數字 (或問號) 圓圈。``地圖預覽：接到任務時會自動顯示地圖，方便預覽任務的位置。``建議裝備：拿到比身上好的裝備時會自動建議更換裝備。``這些功能都可以在設定選項中開啟或關閉。``|cffFF2D2D這個插件的記憶體使用量較大。電腦較慢，或打副本/團隊不需要使用時請勿載入，以免影響遊戲效能。|r``版權所有(c) 2010-2016 UltimateWoWGuide.com`",
	modifier = "彩虹ui",
...
D["EasyFrames"] = {
	...
	{
		type = "text",
        text = "顯示血量數字和百分比：按 Esc > 介面 > 顯示 > 狀態文字 > 選擇 '數值'，然後便可以在暴雪風格頭像的設定選項中調整血量條文字格式。",       
	},
};
D["EKplates"] = {
	defaultEnable = 0,
...
D["EnhBloodlust"] = {
	...
	{
		type = "text",
		text = "調整音量：從 Esc > 系統 > 音效，調整遊戲的主音量。\n\n自訂音樂：將長度為40秒的 MP3 或 OGG 音樂檔案放到 AddOns\\EnhBloodlust 資料夾內。然後用記事本或 Notepad++ 編輯 hawayconfig.lua。\n\n更詳細的說明請看\nhttp://wp.me/p7DTni-Fp \n",
	}
};
D["Exlist"] = {
	defaultEnable = 1,
...
D["ExtVendor"] = {
	defaultEnable = 1,
	title = "商人介面增強/賣垃圾",
	desc = "快速賣出垃圾/無法使用的裝備，以及避免購買到重複的專業圖紙。``和 NPC 交易時會加大商人的購物視窗，可以用滑鼠滾輪來換頁。提供多種過濾方式，過濾已經學會、已經購買過、不能使用的物品、裝備部位、塑形外觀...等等。``也有快速賣垃圾和不要的物品功能，並且可以自訂要賣出和不要賣出的物品清單。`",
	modifier = "BNS, 彩虹ui",
...
D["HandyNotes_BattleForAzerothTreasures"] = { defaultEnable = 1, };
D["HandyNotes_BrokenShore"] = { defaultEnable = 0, };
D["HandyNotes_DraenorTreasures"] = { defaultEnable = 0, };
D["HandyNotes_DungeonLocations"] = { defaultEnable = 0, };
D["HandyNotes_LegionClassOrderHalls"] = { defaultEnable = 0, };
D["HandyNotes_LegionRaresTreasures"] = { defaultEnable = 0, };
...
D["IcyDemonsIndicator"] = {
    ...
    },
	{
		...
		options = {"上","UP","下","DOWN"},
		default	= "DOWN",
        callback = function(cfg, v, loading) SlashCmdList["ICYDEMONSINDICATOR"]("grow " .. v) end,
    },
	{
        text = "恢復為預設值",
        callback = function(cfg, v, loading) SlashCmdList["ICYDEMONSINDICATOR"]("reset") end,
    },
};
...
D["JustInTime"] = {
	...
	tags = { "BOSSRAID" },
	title = "排本等候時間",
	desc = "顯示排隨機隊伍的等待時間和進入確認的剩餘時間，並且移除 '取消' 按鈕以避免按錯。``要取消請點小地圖按鈕的 '眼睛' 按鈕。`",
	modifier = "彩虹ui",
...
D["Lime"] = {
	...
	tags = { "BOSSRAID" },
	title = "萊姆團隊框架",
	desc = "簡單好用又美觀的團隊框架，載入即可使用，幾乎不用設定。``有提供自訂外觀和其他功能。對於補師，還有滑鼠點一下快速施法的功能。`",
	modifier = "彩虹ui",
	icon = "Interface\\Icons\\inv_misc_food_41",
	img = true,
	{
        text = "設定選項",
        callback = function(cfg, v, loading) SlashCmdList["lime"]("") end,
    },
};
D["LiteBag"] = {
	defaultEnable = 0,
...
D["PersoLootRoll"] = {
	...
	tags = { "BOSSRAID" },
	title = "個人拾取分裝助手",
	desc = "好東西要和好基友分享，個人拾取分裝助手讓個人拾取分享裝備更容易!``拿到自己不需要且能夠交易的裝備時，可以在骰裝視窗中將它送出去。``隊友如果也有安裝這個插件，分享他不需要的裝備時，會跳出骰子面板讓你按需求或貪婪。`",
    author = "Shrugal",
	modifier = "BNS, 彩虹ui",
...
D["PersonalLootHelper"] = {
	...
	{
        text = "設定選項",
        callback = function(cfg, v, loading) SlashCmdList["PLHCommand"]("") end,
    },
};
D["PetTracker"] = {
    defaultEnable = 0,
...
D["SilverDragon"] = {
	...
	tags = { "MAP" },
	title = "稀有怪獸與牠們的產地",
	desc = "記錄稀有怪的位置和時間，發現時會通知你。支援舊地圖的稀有怪!``發現稀有怪獸時預設的通知效果會顯示通知面板、螢幕閃紅光和發出音效，還可以和隊友、公會同步通知發現的稀有怪，都可以在設定選項中調整。`",
	modifier = "彩虹ui",
...
D["SimpleVignette"] = {
	...
	tags = { "MAP" },
	title = "稀有怪和寶箱通知",
	desc = "小地圖上出現稀有怪和寶箱時，會在畫面中間顯示文字並播放音效通知你。``|cffFF2D2D特別注意：只有小地圖上出現星號和圖示的稀有怪和寶箱才會通知。|r``要尋找舊地圖的稀有怪可以到奇樂網站下載安裝 '稀有怪獸與牠們的產地' 插件。`",
	modifier = "BNS, 彩虹ui",
...
D["Stuf"] = {
	...
	{
		type = "text",
        text = "看不到設定選項時，請先按取消，然後再按一次 '設定選項' 按鈕。\n\n施法條：從設定選項 > 玩家 > 施法條，調整和移動自己的施法條。\n\n更換頭像外觀風格，不使用 Stuf 頭像的玩家施法條時，可以載入 '達美樂-施法條' 模組。\n\n同時出現兩個施法條時，請關閉 '達美樂-施法條' 模組，或是 Stuf 頭像的玩家施法條其中一個。\n",       
	},
	{
		type = "text",
        text = " ",       
...
D["TargetNameplateIndicator"] = {
	...
	{
		type = "text",
		text = "顯示箭頭：一定要開啟敵方和友方的名條/血條，才能顯示出箭頭。\n\n更改箭頭圖案、位置、大小和透明度：用記事本或 Notepad++ 編輯 AddOns\\\nTargetNameplateIndicator 資料夾內 config 開頭的3個檔案，依照裡面的說明來修改，有30種箭頭圖案可供選擇。",
	}
};
D["TidyPlates"] = {
    defaultEnable = 0,
...
D["TidyPlatesContinued"] = {
    ...
    {
        text = "設定選項",
        callback = function(cfg, v, loading) SlashCmdList["TidyPlatesCont"]("") end,
    },
	{
		type = "text",
        text = "|cffFF2D2D啟用插件後需要重新載入介面。|r",       
...
D["TidyPlates_ThreatPlates"] = {
	...
	{
		type = "text",
        text = "|cffFF2D2D請勿和 Tidy 血條或其他血條插件同時載入使用。|r",       
	},
	{
		type = "text",
        text = "增益圖示：從設定選項 > 套件 > 光環 > 增益，調整是否要在血條上顯示增益圖示。\n\n自動切換血條/名字：威力血條有血條檢視 (同時顯示血條和名字) 和 名字檢視 (只顯示名字) 兩種模式，預設為離開戰鬥會自動切換成名字檢視，讓非戰鬥時能夠充分享受遊戲內容畫面，不受血條干擾。|n|n要啟用/停用自動切換血條的檢視模式，請到設定選項 >  一般設定 > 自動 > 非戰鬥中使用名字檢視。",
	},
};
D["TipTac"] = {
    defaultEnable = 0,
...
D["VuhDo"] = {
	...
	tags = { "CLASSALL" },
	title = "巫毒治療框架",
	desc = "用來取代隊伍/團隊框架，滑鼠點一下就能快速施放法術/補血，是補師的好朋友!``可以自訂框架的外觀、順序，提供治療、驅散、施放增益效果、使用飾品、距離檢查和仇恨提示和更多功能。``還有精美且清楚的 HOT 和動畫效果提醒驅散的 DEBUFF 圖示。`",
	...
	{
		type = "text",
        text = "設定檔懶人包匯入教學請看\nhttps://addons.miliui.com/show/20/1\n\n更多設定檔下載\nhttps://wago.io/vuhdo\n",
	},
};
D["WeakAuras"] = {
    defaultEnable = 0,
...
D["zz_itemsdb"] = {
	...
	tags = { "ITEM" },
	title = "物品數量追蹤",
	desc = "在物品的滑鼠提示中顯示其他角色擁有相同物品的數量。``請在設定選項中勾選要追蹤背包、銀行、公會銀行、兌換通貨... 等等哪些地方的物品數量，以及刪除不再需要追蹤的角色資料。`",
	modifier = "彩虹ui",
