...
L["Alt-right-click to configure manual filtering."] = "Alt-右鍵點擊以設置手動篩選。"
L["Alt-right-click to configure the Junk module."] = "Alt-右鍵點擊以設置垃圾模組。"
...
L["Check this to have poor quality items dimmed."] = "黯淡粗糙品質的物品"
...
L["Display character currency at bottom left of the backpack."] = "在背包左下角顯示角色通貨"
...
L["Press Alt while doing so to open a dropdown menu."] = "按下Alt鍵，而這樣做可以打開一個下拉選單。"
L["Priority"] = "優先順序"
...
L["Section header"] = "分類標題"
L["Section setup"] = "類別設定"
L["Section visibility"] = "分類可見度"
L["Section visibility button"] = "類別可見按鈕"
...
L["Split armors by types"] = "根據護甲種類進行分類"
...
L["When alt is held down"] = "當按住 alt"
L["When any modifier key is held down"] = "當按住任何組合鍵"
L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] = "勾選時，可在背包的空白處點擊右鍵，以打開設定選單。"
L["When ctrl is held down"] = "當按住 ctrl"
L["When shift is held down"] = "當按住 shift"
...
L["Automtically deposit all reagents into the reagent bank when you talk to the banker."] = "當你與銀行行員對談時自動存放所有材料到材料銀行。"
L['Position & size'] = "位置 & 尺寸"
L['Section layout'] = "分類佈局"
L['Compact layout'] = "緊湊佈局"
L['Reagent bank color'] = "材料銀行顏色"
L['When enabled, AdiBags reorder the section to achieve a more compact layout.'] = "當啟用後，AdiBags重新排列類別以實現更緊湊的佈局。"
L["(Blizzard's) Sort items"] = "(暴雪)整理物品"
L["Recent items"] = "新進物品"
L["This special section receives items that have been recently moved, changed or added to the bags."] = "這個特殊類別容納最近有移動，改變或添加到該背包的物品。"
