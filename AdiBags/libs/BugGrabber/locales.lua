...
L["AdiBags Anchor"] = "AdiBags 위치 고정기"
...
L["Same as InventoryItemLevels"] = "Mit den üblichen Farben der Gegenstandsstufen"
L["Scale"] = "Skalierung"
L["Section"] = "Bereich"
...
L["Show every distinct item stacks."] = "Jeden einzelnen Stapel so wie in den Taschen zeigen"
...
L["At merchants', bank, auction house, ..."] = "在商人、銀行、拍賣場等"
L["auto-deposit"] = "自動存放"
...
L["Dim junk"] = "灰色垃圾"
L["disabled"] = "停用"
L["Display a smaller money frame. This setting will take effect on next reload."] = "显示一个较小的货币框体。此项设定重载界面后生效。"
...
L["Display the level of equippable item in the top left corner of the button."] = "显示按钮的左上角含装备等级的物品。"
L["Do not show anchor point"] = "不要显示锚点"
L["Do not show level of heirloom items."] = "不要显示水平的传家宝。"
L["Do not show level of items that cannot be equipped."] = "不要显示无法装备的物品等级。"
L["Do not show level of poor quality items."] = "不要显示质量差的物品等级"
L["Do not show levels under this threshold."] = "不要显示此阈值等级下的物品。"
...
L["Hide zeroes"] = "隐藏零"
L["Highlight changes"] = "突显变动"
L["Highlight color"] = "高亮颜色"
L["Highlight scale"] = "高亮缩放"
L["Highlight style"] = "突显方式"
L["Highlight what changes in bags with a little sparkle."] = "以闪光来突显背包内的变动。"
L["If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."] = "如果插件看上去不能正常工作，请再向作者提交报告之前重新允许错误报告检查一次。"
...
L["Legacy"] = "传承"
L["Let SyLevel handle the the display."] = "让 SyLevel 处理显示。"
L["Lock anchor"] = "锁定锚点"
...
L["Merged sets"] = "合并套装"
L["MINING_BAG_TAG"] = "矿"
L["Mininum level"] = "最低限度的等级"
L["Money"] = "金钱"
L["Move items from and to the bank by right-clicking on section headers."] = "通過類別標題右鍵單擊進行，移動該類別物品到銀行。"
L["Never"] = "从不"
L["New"] = "新物品"
L["New Override"] = "新建覆盖"
L["New section"] = "新分类"
...
L["Only equippable items"] = "只有装备的物品"
...
L["Right-click to toggle %s."] = "右键点击切换％S。"
...
L["Slot number"] = "槽号"
L["Small"] = "小型"
L["Sort items by bind type."] = "依绑定类型排序。"
...
L["Which color scheme should be used to display the item level ?"] = "应该使用哪种颜色设定显示物品的等级?"
L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] = "在与银行职员对话的同时按住「辅助按键」，可避免自动存放功能。"
...
L["Adjust the maximum height of the bags, relative to screen size."] = "Настройте высоту сумок в соответствии с разрешением монитора."
L["Adjust the width of the bag columns."] = "Настройте количество колонок в сумках."
...
L["Alt-right-click to configure manual filtering."] = "Alt + Правая кнопка мыши для настройки сортировки."
L["Alt-right-click to configure the Junk module."] = "Alt + Правая кнопка мыши для настройки хлама."
L["Alt-right-click to switch to anchored placement."] = "Alt + Правая кнопка мыши для закрепления окна."
L["Alt-right-click to switch to manual placement."] = "Alt + Правая кнопка мыши для открепления окна и перемещения."
L["Always"] = "Всегда"
L["AMMO_TAG"] = "Бп"
...
L["At merchants', bank, auction house, ..."] = "При торговле, в банке, в аукционном доме, ...:"
L["auto-deposit"] = "Автоматически сдавать реагенты"
L["Automatically open the bags at merchant's, bank, ..."] = "Автоматически открывать сумки при торговле и в банке."
L["auto-sort"] = "Автоматическая сортировка"
...
L["Check to enable this module."] = "Включите флажок, чтобы включить модуль."
...
L["Column width"] = "Количество колонок"
...
L["Do not show anchor point"] = "Не показывать якорь"
...
L["HERB_BAG_TAG"] = "Тр"
L["Hide the colored corner shown when you move the bag."] = "Не показывать желтый квадрат при перемещении окна сумок."
...
L["Merge stackable items"] = "Объединять стопки"
...
L["Open automatically"] = "Показывать автоматически"
...
L["Right-click to open options"] = "Открывать настройки по правой кнопке мыши."
...
L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] = "Когда флажок включен то по клику правой кнопкой мыши в сумках на пустом месте открывает окно настроек."
...
L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] = "Для отключения автоматической сдачи реагентов нажмите клавишу-модификатор перед разговором с банкиром."
...
L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] = "È possibile reimpostare manualmente la sezione in cui si vuole posizionare un oggetto. Basta trascinare un oggetto sul titolo della sezione."
L["Ammunition"] = "Munizioni"
L["Bag usage format"] = "Formato dell'uso delle borse."
L["Bags"] = "Borse"
...
L["Check this to display a colored border around items, based on item quality."] = "Selezionare questa opzione per visualizzare un bordo colorato attorno agli oggetti in base alla loro qualità."
...
L["Check this to display an textual tag before usage of each type of bags."] = "Selezionare questa opzione per visualizzare una frase di testo prima dell'uso di ogni tipo di borsa."
L["Check this to display one individual section per set. If this is disabled, there will be one big \"Sets\" section."] = "Selezionare questa opzione per visualizzare una sezione separata per ogni set di equipaggiamento. In caso contrario, ci sarà una sola sezione denominata \"Set\"."
