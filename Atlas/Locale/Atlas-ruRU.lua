...
L["ATLAS_DEP_MSG2"] = "Они будут отключены для этого персонажа."
L["ATLAS_DEP_MSG3"] = "Удалите их из вашей папки модификаций."
L["ATLAS_DEP_OK"] = "ОК"
...
L["ATLAS_OPTIONS_COLORINGDROPDOWN_TIP"] = "Полагаясь на предложенный минимальный уровень подземелья и уровень игрока, окрашивать названия подземелий с учётом их уровня сложности."
...
соответствующий модуль(и) карт Atlas.]=]
