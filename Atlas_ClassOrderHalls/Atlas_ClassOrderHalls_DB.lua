-- $Id: Atlas_ClassOrderHalls_DB.lua 56 2016-10-25 16:39:31Z arith $
--[[
...
local myDB = {
	...
	CH_DemonHunter = {
		...
		{   8, 10008, 103, 175 }; -- Asha Ravensong
		{   9, 10009, 123, 179 }; -- Ariana Fireheart <Illidari>
		{  10, 10010, 140, 172 }; -- Izal Whitemoon
		{  11, 10011, 100, 94 }; -- Training Dummies
		{  12, 10012, 375, 355 }; -- Jace Darkweaver <Illidari>
		{  13, 10013, 395, 350 }; -- Vahu the Weathered <Illidari Researcher>
		{  14, 10014, 347, 294 }; -- Loramus Thalipedes <Class Hall Upgrades>
		{  15, 10015, 375, 249 }; -- Empowered Nether Crucible
		{  16, 10016, 374, 119 }; -- Cursed Forge of the Nathrezim
		{  17, 10017, 357, 129 }; -- Seer Akalu
	};
	CH_Druid = {
	...
	CH_Hunter = {
		...
		{ "7", 10007, 252, 338 }; -- Holt Thunderhorn <Lore and Legends>
		{ "8", 10008, 273, 318 }; -- Training Dummies
		{ "8", 10008, 207, 291 }; -- Training Dummies
		{ "8", 10008, 188, 306 }; -- Training Dummies
		{ "9", 10009, 202, 277 }; -- Lenara <Recruiter>
		{ "10", 10010, 289, 322 }; -- Survivalist Bahn <Class Hall Upgrades>
		{ "11", 10011, 283, 257 }; -- Sampson <Recruiter>
	};
	CH_Mage = {
	...
	CH_Rogue = {
		{ "A", 10101, 430, 356 }; -- Glorious Goods
		{ "B", 10102, 247, 141 }; -- One More Glass
		{ "C", 10103, 190, 154 }; -- Tanks for Everything
		{ "D", 10104, 4, 424 }; -- Tunnel of Woe
		{ "1", 10001, 333, 235 }; -- Madam Gosu <Black Market Liaison>
		{ "2", 10002, 249, 339 }; -- Lord Jorach Ravenholdt
		{ "3", 10003, 236, 306 }; -- Filius Sparkstache <Archivist>
		{ "4", 10004, 198, 310 }; -- Marin Noggenfogger <Baron of Gadgetzan>
		{ "5", 10005, 181, 280 }; -- Crucible of the Uncrowned
		{ "6", 10006, 230, 230 }; -- Nikki the Gossip <Tales fo Adventure and Profit>
		{ "7", 10007, 175, 154 }; -- Rouge Trainers
		{ "8", 10008, 167, 172 }; -- Training Dummies
		{ "9", 10009, 181, 200 }; -- Kelsey Steelspark <Quartermaster>
	};
	CH_Shaman = {
	...
	CH_Warlock = {
		...
		{ "1", 10001, 307, 246 }; -- Calydus
		{ "2", 10002, 289, 259 }; -- Unjari Feltongue <The Heartbearer>
		{ "3", 10003, 292, 245 }; -- Felblood Altar
		{ "4", 10004, 392, 315 }; -- Lurr <Dreadscar Blacksmith>
		{ "5", 10005, 403, 304 }; -- Jared <Recruiter>
		{ "6", 10006, 428, 294 }; -- Gakin the Darkbinder <Mission Strategist>
		{ "7", 10007, 399, 255 }; -- Gigi Gigavoid <Black Harvest Quartermaster>
		{ "8", 10008, 390, 279 }; -- Mile Raitheborne <Head Archivist>
		{ "9", 10009, 250, 336 }; -- Training Dummies
		{ "9", 10009, 274, 365 }; -- Training Dummies
		{ "9", 10009, 303, 376 }; -- Training Dummies
		{ "9", 10009, 326, 341 }; -- Training Dummies
	};
	CH_Warrior = {
		...
		{ "6", 10005, 147, 135 }; -- Fjornson Stonecarver <Keeper of Legends>
		{ "7", 10006, 156, 139 }; -- Einar the Runecaster <Class Hall Upgrades>
		{ "8", 10007, 108, 173 }; -- Master Smith Helgar
		{ "9", 10008, 356, 179 }; -- Weaponmaster Asvard <Warrior Trainer>
		{ "10", 10009, 390, 179 }; -- Arena of Glory
		{ "11", 10010, 436, 179 }; -- Training Dummies
		{ "12", 10011, 226, 422 }; -- Hymdall
		{ "13", 10012, 245, 432 }; -- Odyn
	};
};
