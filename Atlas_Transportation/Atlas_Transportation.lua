-- $Id: Atlas_Transportation.lua 71 2017-01-24 14:23:35Z arith $
--[[
...
local myData = {
	...
	TransAllianceBrokenIsles = {
		...
		{ NUTL.." 8) "..BZ["Azurewing Repose"]..GREY.." (48.4, 28.0)", 10008 };
		{ INDENT..CL["WARRIOR"]..L["Warrior's landing / jumping point (from or back to Skyhold)"]..GREY.." (47.6, 28.1)" };
		{ NUTL.." 9) "..BZ["Challiane's Terrace"]..GREY.." (40.8, 9.0)", 10009 };
		{ NUTL.."10) "..BZ["Eye of Azshara"]..GREY.." (38.3, 46.1)", 10010 };
		{ "" };
		{ BLUE..BZ["Val'sharah"] };
		{ NUTL.."11) "..BZ["Lorlathil"]..GREY.." (55.0, 72.5)", 10011 };
		{ INDENT..CL["WARRIOR"]..L["Warrior's landing / jumping point (from or back to Skyhold)"]..GREY.." (54.7, 74.9)" };
		...
		{ NUTL.."19) "..BZ["Thunder Totem"]..GREY.." (44.9, 38.7)", 10019 };
		{ INDENT..CL["WARRIOR"]..L["Warrior's landing / jumping point (from or back to Skyhold)"]..GREY.." (39.8, 42.2)" };
		...
		{ NUTL.."30) "..BZ["Valdisdall"]..GREY.." (60.7, 50.9)", 10030 };
		{ INDENT..CL["WARRIOR"]..L["Warrior's landing / jumping point (from or back to Skyhold)"]..GREY.." (60.2, 52.2)" };
		...
		{ NUTL.."35) "..BZ["Meredil"]..GREY.." (34.4, 49.4)", 10035 };
		{ INDENT..CL["WARRIOR"]..L["Warrior's landing / jumping point (from or back to Skyhold)"]..GREY.." (33.1, 48.2)" };
