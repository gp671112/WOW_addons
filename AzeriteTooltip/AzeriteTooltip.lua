...
Options:SetScript("OnShow", function()
	...
	local RemoveBlizzard = AzeriteTooltip:CreateCheckBox("RemoveBlizzard", Options, "替換暴雪艾澤萊說明文字", nil, Title, 0, -30, false)
    ...
    local OnlySpec = AzeriteTooltip:CreateCheckBox("OnlySpec", Options, "只顯示你當前專精的特質", nil, RemoveBlizzard, 0, -5, false)
    ...
    local Compact = AzeriteTooltip:CreateCheckBox("Compact", Options, "精簡模式(只有圖示)", nil, OnlySpec, 0, -5, false)
