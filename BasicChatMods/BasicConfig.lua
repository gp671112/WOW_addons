...
BCM.modules[#BCM.modules+1] = function()
	...
	bcmTitle:SetText(name.." v8.0.4") --wowace magic, replaced with tag version
	...
	--[[ Alt invite ]]--
	makePanel("BCM_AltInvite", bcm, "Alt快速邀請")

	--[[ Auto Log ]]--
	makePanel("BCM_AutoLog", bcm, "自動記錄")
	...
	--[[ Button Hide ]]--
	makePanel("BCM_ButtonHide", bcm, "隱藏按鈕")

	--[[ Channel Names ]]--
	makePanel("BCM_ChannelNames", bcm, "頻道名稱自訂")
	...
	--[[ Chat Copy ]]--
	makePanel("BCM_ChatCopy", bcm, "聊天複製")
	...
	--[[ Fade ]]--
	makePanel("BCM_Fade", bcm, "淡出")

	--[[ Font ]]--
	makePanel("BCM_Font", bcm, "字型")
	...
	--[[ GMOTD ]]--
	makePanel("BCM_GMOTD", bcm, "公會訊息")

	--[[ Highlight ]]--
	makePanel("BCM_Highlight", bcm, "高亮提醒")
	...
	--[[ History ]]--
	makePanel("BCM_History", bcm, "歷史紀錄")
	...
	--[[ Justify ]]--
	makePanel("BCM_Justify", bcm, "文字對齊")
	...
	--[[ Player Names ]]--
	makePanel("BCM_PlayerNames", bcm, "玩家名字自訂")
	...
	--[[ Resize ]]--
	makePanel("BCM_Resize", bcm, "改變大小")

	--[[ Scroll Down ]]--
	makePanel("BCM_ScrollDown", bcm, "向下滾動")

	--[[ Sticky ]]--
	makePanel("BCM_Sticky", bcm, "頻道黏附")
	...
	--[[ Tell Target ]]--
	makePanel("BCM_TellTarget", bcm, "密語目標")

	--[[ Timestamp Customize ]]--
	makePanel("BCM_Timestamp", bcm, "時間戳")
	...
	--[[ URLCopy ]]--
	makePanel("BCM_URLCopy", bcm, "網址複製")
