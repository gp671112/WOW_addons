...
function ClassMods:OnInitialize()
	...
	-- Fonts
	media:Register("font", "Arial Narrow", [[Fonts\bHEI01B.ttf]])
	media:Register("font", "Big Noodle", [[Fonts\bLEI00D.ttf]])
	media:Register("font", "預設字型", [[Fonts\bLEI00D.ttf]])
	media:Register("font", "聊天字型", [[Fonts\bHEI00M.TTF]])
	media:Register("font", "傷害字型", [[Fonts\bKAI00M.ttf]])
	-- Status Bars
...
function ClassMods.AbbreviateNumber(rawNumber)
	...
	if rawNumber > 100000000 then
		newNumber = ("%.02f億"):format(rawNumber/100000000)
	end
	if rawNumber <= 100000000 then
		newNumber = ("%.02f萬"):format(rawNumber/10000)
	end
