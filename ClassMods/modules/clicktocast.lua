...
function ClassMods.SetupClickToCast()
	...
	if not ClassMods.db.profile.clicktocast.spell then
		ClassMods.macroStr = "/cast [@mouseover,exists,nounithasvehicleui,novehicleui] "..ClassMods.clickToCastDefault
	else
		local spellToCast
