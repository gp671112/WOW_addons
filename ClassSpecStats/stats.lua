local x = {}
x["Version"] = "|cFFFAFA44裝備屬性建議：|cFF00EA00 2017.12.1|r"

--[[ Deathknight Blood]]
x[250] = "平衡：Str > Haste > Vers > Crit > Mast \n最大輸出：Str > Haste > Crit > Vers > Mast \n生存能力：Str > Haste > Vers > Mast > Crit "
--[[ Deathknight Frost]]
x[251] = "Str > Mast 40% > Haste 30% > Crit 30% >= Haste > Vers"
--[[ Deathknight Unholy]]
x[252] = "Str > Haste 26% > Mast > Crit 或 Vers (依裝等而定) > Haste"

--[[ Druid Balance]]
x[102] = "Mast > Haste > Int > Crit > Vers"
--[[ Druid Feral]]
x[103] =  "遍體鱗傷：Mast > Crit > Agi > Vers > Haste \n 化身：Vers > Crit > Agi > Mast > Haste"
--[[ Druid Guardian]]
...
--[[ Hunter Beastmaster]]
x[253] = "Agi >  Crit (動物園), Mast (其他) > Haste > Mast (動物園), Crit(其他) > Vers \n動物園天賦點法：2111112"
--[[ Hunter Marksmanship]]
x[254] = "Mast 或 Crit (依套裝特效而定) > Haste > Vers > Agi"
--[[ Hunter Survival]]
...
--[[ Monk Brewmaster]]
x[268] = "(Mast = Crit = Vers) > Haste 14.3% > Agi"
--[[ Monk Mistweaver]]
...
--[[ Rogue Subtlety]]
x[261] = "標準：Agi > (Mast >= Vers) > Crit > Haste \nT21 4件套裝：Crit > Vers > Mast > Agi > Haste"

--[[ Shaman Elemental]]
x[262] = "冰怒：Int > Crit > Haste > (Mast = Vers) \n卓越術：Int > Haste > (Crit = Mast) > Vers) \n聚雷針：Int > Haste > Crit > Mast > Vers"
--[[ Shaman Enhancement]]
