...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 16100 $"):sub(12, -3)),
	DisplayVersion = "7.2.0 BNS", -- the string that is shown as version
	ReleaseRevision = 16100 -- the revision of the latest stable version that is available
}
