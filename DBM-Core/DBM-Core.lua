...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 15927 $"):sub(12, -3)),
	DisplayVersion = "7.1.15 BNS", -- the string that is shown as version
	ReleaseRevision = 15927 -- the revision of the latest stable version that is available
}
