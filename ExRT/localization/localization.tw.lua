...
PH.TimerTimeToKillTime = "計算時間，以秒計"
...
PH.InviteMasterlootersTooltip = "團隊分配名字(以空白區隔)"			
...
L.BossWatcherPerCast = "每次施法"
L.BossWatcherOnlySegmentsWithAura = "只選擇有啟用光環的區段"
L.BossWatcherOnlySegmentsWithEnemy = "只選擇有啟用目標的區段"	
...
PH.LoggingHelp1 = "戰鬥記錄保存於Logs\WoWCombatLog.txt中。你可以上傳記錄至專門的分析網站(如 www.warcraftlogs.com). 別忘了在每次出團後上傳和刪除這檔案，避免檔案容量過大。"			
...
L.TranslateBy = "永霜 @ TW-Wrathbringer，補完：三皈依 @ TW-世界之樹"