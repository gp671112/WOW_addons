...
L.BossmodsMalkorokSkadaTooltip = "Skada插件的模組。顯示有效的治療 (All healing under green shield |TInterface\\Icons\\ability_malkorok_blightofyshaarj_green:0|t\|cff00ff00Strong Ancient Barrier|r on the target will be as overhealing)"			
L.BossmodsMalkorokSkadaError1 = "Skada未找到"			
L.BossmodsMalkorokSkadaError2 = "模組已載入"			
...
L.TimerTimeToKillTime = "計算的時間，以秒計"
