...
merge(ns.points[862], { -- Zuldazar
    ...
    [67732903] = {quest=nil, npc=135512, achievement=13048, criteria=41675, note="與古代的Azuresail以及Kil'Tawan共享重生時間",}, -- Thuderfoot the Brutosaur
    [67102657] = {quest=nil, npc=135510, achievement=13048, criteria=41676, note="與雷足以及Kil'Tawan共享重生時間",}, -- Azuresail the Diemetrodon
    [71134034] = {quest=nil, npc=139365, achievement=13048, criteria=41672, note="野人之地南邊",}, -- Queenfeather the Ravasaur
    [52394771] = {quest=nil, npc=129323, achievement=13048, criteria=41674, note="可以在靠近路邊的草中找到",}, -- The Sabertusk Empress
    [66082238] = {quest=nil, npc=143910, achievement=13048, criteria=41684, note="奈辛瓦里營地的南邊",}, -- Sludgecrusher the Anklyodon
    [61622537] = {quest=nil, npc=130741, achievement=13048, criteria=41673, note="在路口與Ten'gor戰鬥",}, -- Nol'ixwan the Direhorn
    [71242184] = {quest=nil, npc=123502, achievement=13048, criteria=41677, note="在從Zeb'ahari到Tal'gurub的路上",}, -- King K'tal the Devilsaur
    -- Mushroom Harvest
    [45537917] = {npc=143314, achievement=13027, criteria=41391, note="海灘的樹之間",}, -- Bane of the Woods
})
...
merge(ns.points[863], { -- Nazmir
    ...
    -- Life Finds a Way... To Die!
    [25706971] = {quest=nil, npc=143898, achievement=13048, criteria=41683, note="飛得靠近在從沃魯敦到祖達薩的路上",}, -- Makatau the Pterrordax
    -- Mushroom Harvest
    [52357020] = {npc=143316, achievement=13027, criteria=41390, note="黑暗之心南邊。入口位於Xal'vor遺址的北側",}, -- Skullcap
    [73614870] = {npc=143311, achievement=13027, criteria=41393, note="在洞穴，入口位於73.2 49.7",}, -- Toadcruel
...
merge(ns.points[864], { -- Vol'dun
    ...
    [53685347] = {quest=47533, npc=130443, achievement=12943, criteria=41616, note="在洞穴"}, -- Hivemother Kraxi
    ...
    [38284138] = {quest=51424, npc=137681, achievement=12943, criteria=41620, note="在洞穴"}, -- King Clickyclack
    ...
    [46972518] = {quest=50637, npc=134571, achievement=12943, criteria=41626, note="在洞穴",}, -- Skycaller Teskris
    ...
    [43915405] = {quest=48319, npc=129411, achievement=12943, criteria=41633, note="在沙子下面的骨骸裡面"}, -- Zunashi the Exile
    [43985246] = path{quest=48319},
    -- Mushroom Harvest
    [61101826] = {npc=143313, achievement=13027, criteria=41392, note="支柱覆蓋著，在山上",}, -- Portakillo
})
merge(ns.points[895], { -- Tiragarde Sound
    ...
    [84707385] = {quest=51808, npc=139145, item=154411, achievement=12939, criteria=41798, note="洞穴上方的山坡",}, -- Blackthorne
    ...
    [61515233] = {quest=49963, npc=130350, item=155571, note="騎乘到南風渡船站的Roan Berthold，沿著路走",}, -- Guardian of the Spring (49983 is the ride, 49963 is the loot)
...
merge(ns.points[896], { -- Drustvar
    ...
    [59245526] = {quest=48981, npc=127877, achievement=12941, criteria=41713, note="選一個來戰鬥; 匕首來自Longfang，郵件手套來自亨利",}, -- Longfang & Henry Breakwater
...
merge(ns.points[942], { -- Stormsong Valley
    ...
    [53416451] = {quest=52324, npc=141043, item=nil, achievement=12940, criteria=nil, faction="Alliance", note="與Doc Martens交談",}, -- Jakala the Cruel
