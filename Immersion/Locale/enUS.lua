...
L['Anchor to NPC nameplate'] = "Anchor to NPC nameplate"
L['Toggle CVar'] = "Toggle CVar"
L['Show frame on NPC nameplate. This feature requires a CVar to be enabled (nameplateShowFriends).\nClick on the button above to toggle this CVar on/off.\n\nNote that you might have to press Cancel in the interface options for the CVar changes to take effect.'] = "Show frame on NPC nameplate. This feature requires a CVar to be enabled (nameplateShowFriends).\nClick on the button above to toggle this CVar on/off.\n\nNote that you might have to press Cancel in the interface options for the CVar changes to take effect."
L['Toast when quest is supertracked'] = "Toast when quest is supertracked"
