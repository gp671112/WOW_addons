...
L["Disable fly-in animation"] = "停用滑入動畫效果"
L["Disable horizontal drag"] = "停用水平方向拖曳"
L["Disable portrait border"] = "停用頭像外框"
...
L["Show text progress bar"] = "顯示文字進度列"
L["Solid background"] = "單色背景 (不透明)"
...
L["The regular talking head frame appears in the same place as Immersion when you're not interacting with anything and on top of Immersion if they are visible at the same time."] = "沒有和任何事物互動時，標準的說話的頭框架會顯示在任務內容對話相同的位置。當兩者同時出現時，說話的頭會顯示在任務內容對話的上方。"
L["Tooltip"] = "滑鼠提示"
L["Top"] = "上方"
