...
version:SetText(string.format(
    opt.titles.version,
    'KuiNameplates','Kesava','2-14-1-g1e33471'
))
...
combat_hostile.SelectTable = {'不做什麼','隱藏','顯示'}
combat_friendly.SelectTable = {'不做什麼','隱藏','顯示'}
...
bar_animation.SelectTable = {'無','平滑','切除'}
...
font_style.SelectTable = { '無','外框','陰影','陰影+外框','無消除鋸齒' }
...
auras_sort.SelectTable = {'光環索引','剩餘時間'}
