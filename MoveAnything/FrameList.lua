...
local m = {
	...
	LoadList = function(self)
		...
		API:AddElement({name = "ExtraActionBarFrame", displayName = "額外快捷列"}, c)
		...
		API:AddElement({name = "ChallengeKeystoneFrame", displayName = "挑戰鑰石"}, c)
		...
		API:AddElement({name = "CompactRaidFrameManager", displayName = "團隊隊伍管理員"}, c)
		API:AddElement({name = "CompactRaidFrameManagerToggleButton", displayName = "團隊隊伍管理員切換按鈕", onlyOnceCreated = 1}, c)
		...
		API:AddElement({name = "TransmogrifyFrame", displayName = "塑形"}, c)
		pvpf:AddCategory(c)
		--qldf:AddCategory(c)
		--qlf:AddCategory(c)
		qf:AddCategory(c)
