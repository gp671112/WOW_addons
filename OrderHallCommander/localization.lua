...
L["Empty missions sorted as last"] = "空欄位任務排在最後"
L["Empty or 0% success mission are sorted as last. Does not apply to \"original\" method"] = "欄位為空或0%成功率的任務排列在最後面。不會套用到\"原始\"的方式"
return
end
