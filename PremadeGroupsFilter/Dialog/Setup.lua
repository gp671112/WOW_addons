...
function PGF.Dialog_SetUpUsePGFCheckbox()
    ...
    button.text:SetText(L["PGF"])
    button.text:SetFontObject("GameFontHighlight")
    button.text:SetWidth(70)
    button:SetPoint("LEFT", LFGListFrame.SearchPanel.RefreshButton, "LEFT", -100, 0)
...
function PGF.Dialog_OnLoad()
    ...
    dialog.Title:SetText(L["Premade Groups Filter"])
