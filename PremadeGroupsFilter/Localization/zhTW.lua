...
L["dialog.tooltip.findnumber"] = "過濾詳情中的數字"
L["dialog.tooltip.example"] = "範例"
L["dialog.tooltip.name"] = "標題（白色大字）"
L["dialog.tooltip.comment"] = "詳情（灰色文字）"
...
L["dialog.tooltip.partialid"] = "我有部分進度的副本"
L["dialog.tooltip.fullid"] = "我已全部打完副本"
