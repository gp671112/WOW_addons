...
function Recount:CreateDetailWindow()
	...
	for i = 1, 8 do
		...
		Row.Min:SetPoint("RIGHT", Row, "RIGHT", -225, 0)
		Row.Min:SetText("32")
		...
		Row.Avg:SetPoint("RIGHT", Row, "RIGHT", -160, 0)
		Row.Avg:SetText("32")
		...
		Row.Max:SetPoint("RIGHT", Row, "RIGHT", -90, 0)
		Row.Max:SetText("32")
		...
		Row.Count:SetPoint("RIGHT", Row, "RIGHT", -55, 0)
