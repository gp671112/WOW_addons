			...
			general = {
				...
				args = {
					...
					itemTooltipNetherlight = {
						name = "顯示" .. SPLASH_LEGION_NEW_7_3_FEATURE1_TITLE .. ARTIFACTS_PERK_TAB .. ":",
						desc = "何時要在神兵武器的滑鼠提示中顯示虛空之光熔爐的特長",
						type = "select",
						width = "single",
...
local function initialize()
	...
	optionsFrame = dialog:AddToBlizOptions("RelicInspector", "裝備-聖物", nil, "general")
