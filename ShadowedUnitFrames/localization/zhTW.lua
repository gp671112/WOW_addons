...
local L = {}
L["1 aura group disabled"] = "1 光環群組已停用"
L["2D"] = "2D"
L["3D"] = "3D"
L["A"] = "A"
...
L["Absolute damage absorption value on the unit, if 10,000 damage will be absorbed, it will show 10,000."] = "在單位的绝對傷害吸收值，如果10,000傷害將被吸收，將會顯示為10,000。"
L["Absolute heal absorb value, if 16,000 healing will be absorbed, it will show 16,000."] = "治療量吸收絕對值, 如果16000的治療量被吸收, 顯示為16,000。"
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "顯示完整的治療量，如10,000治療量則顯示為10,000。"
L["Add"] = "新增"
L["Add aura"] = "新增光環"
L["Add Aura"] = "新增光環"
L["Add Indicator"] = "新增指標"
L["Add link"] = "新增連結"
L["Add new indicator"] = "增加新的指標"
L["Add new tag"] = "新增新標籤"
...
L["Adds a bar indicating how much time is left on your Rune of Power."] = "新增一個條指示你的符文能量剩餘多少時間。"
...
L["Adds a Stagger bar for Brewmaster Monks."] = "為釀酒武僧新增一個醉仙緩勁條。"
...
L["All Auras"] = "所有光環"
L["Allows you to anchor the aura group to another, you can then choose where it will be anchored using the position.|n|nUse this if you want to duplicate the default ui style where buffs and debuffs are separate groups."] = "允許您定位此光環群組到其他人，然後你可以選擇使用哪個位置定位它。|n|n你可以使用這個來複製那些在Buff和Debuff在不同分組的預設UI樣式。"
L["Allows you to disable the totem by right clicking it.|n|nWarning: Inner bars for this unit will not resize in combat if you enable this."] = "允許您透過右鍵點擊取消圖騰。|n|n警告: 如果您啟用此選項，在單位內的項目條不會在戰鬥中調整。"
L["Allows you to enter a new aura group."] = "允許您輸入一個新的光環群組。"
...
L["Alternatively friendly spell to use to check range."] = "另外的友善法術用來檢查範圍。"
L["Alt. Power"] = "替代能量"
...
L["Aura name"] = "光環名稱"
L["Auras"] = "光環"
L["Auras matching a criteria will automatically show up in the indicator when enabled."] = "匹配條件的光環在指標啟用時將自動的顯示。"
...
L["Bars"] = "計量條"
L["Bar spacing"] = "計量條間隔"
L["Bars with an order higher or lower than the full size options will use the entire unit frame width.|n|nBar orders between those two numbers are shown next to the portrait."] = "高於或低於全尺寸選項的條將使用整個單元框架的寬度。|n|n在那兩個數字之間的條在頭像旁邊顯示。"
L["Bar texture"] = "背景材質"
L["Battleground"] = "戰場"
...
L["Border color"] = "邊框顏色"
L["Border coloring of stealable, curable and dispellable auras."] = "可偷取、治癒、驅散的光環外框著色。"
...
L["Changes this widget into a bar, you will be able to change the height and ordering like you can change health and power bars."] = "變更這個小設定到計量條，你可以像修改生命條和能量條那樣修改高度和排列。"
L["Channelling"] = "引導性"
...
L["Color to use to show how much healing will e absorbed."] = "顏色用來顯示有多少治療被吸收了。"
...
L["Current target of a battleground unit."] = "目前戰場單位的目標。"
L["Current target of target of a battleground unit."] = "目前戰場單位目標的目標。"
L["Damage absorption (Absolute)"] = "傷害吸收(絕對值)"
L["Damage absorption/Name"] = "傷害吸收/名稱"
L["Damage absorption (Short)"] = "傷害吸收(簡短)"
L["Dark"] = "暗色"
L["%d auras in group"] = "在團體中的%d光環"
L["Dead"] = "死亡"
L["Debuffs"] = "減益"
...
L["Has Aggro"] = "引起仇恨"
L["Heal absorb"] = "治療吸收"
L["Heal Absorb (Absolute)"] = "治療吸收(完整值)"
L["Heal absorbs"] = "治療吸收"
L["Heal Absorb (Short)"] = "治療吸收(簡短)"
...
L["How many seconds between updates.|n[WARNING] By setting the frequency to 0 it will update every single frame redraw, if you want to disable frequent updating uncheck it don't set this to 0."] = "兩次更新之間有幾秒。|n[警告] 通過將頻率設置為0，每一個框架的重繪都會更新，如果你想禁用頻繁更新請取消勾選並且不設置為0。"
...
L["If name is entered, it must be exact as it is case sensitive. Alternatively, you can use spell id instead."] = "如果輸入名稱，它必須是準確的，因為它是區分大小寫的。另外您也可以使用法術ID來代替。"
L["If the unit has a damage absorption shield on them, it will show the absolute absorb value, otherwise the units name."] = "如果單位有傷害吸收護盾，它將顯示絕對吸收值，否則為單位名稱。"
...
L["Indicators"] = "標記"
L["Indicator this aura should be displayed in."] = "此光環的標記將顯示於。"
L["In range alpha"] = "在距離內的透明度"
L["Insanity"] = "瘋狂"
L["Inset"] = "插入"
L["Inside Bottom Left"] = "內部左下"
L["Inside Bottom Right"] = "內部右下"
...
L["Only active this aura inside an indicator if the group member does not have the aura."] = "標記將顯示光環的圖標而不是單純的顏色。。"
L["Only auras you specifically cast will be shown."] = "只有您指定施放的光環會顯示。"
L["Only show if missing"] = "只會顯示缺少的"
L["Only show self cast auras"] = "只顯示自身施放的光環"
...
L["Percentage value of how far outside the unit frame the incoming absorb bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "吸收傷害條可以超出單位框架多少的百分比值。130%意指超過30%，100%意指不超過。"
L["Percentage value of how far outside the unit frame the incoming heal bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "承受治療條可以超出單位框架多少的百分比值。130%意指超過30%，100%意指不超過。"
L["Percent HP"] = "百分比生命值"
...
L["%s aura groups disabled"] = "%s 光環群組已停用"
L["Scale"] = "比例"
...
L["Short classifications, R for Rare, R+ for Rare Elite, + for Elite, B for Boss or M for Minion nothing is shown if they aren't any of those."] = "怪物分類簡稱, 稀有為R, 稀有精英為R+, 精英為+, Boss為B, 爪牙為M, 不包含在這些當中的什麼都不顯示."
L["Short elite indicator"] = "簡化精英標記"
L["Shorten damage absorption, if 13,000 damage will e absorbed, it will show 13k."] = "簡寫傷害吸收, 如果13000的傷害被吸收, 將會顯示為13k."
...
L["Show any other auras"] = "顯示其他任何光環"
...
L["Show castable on other auras"] = "顯示為可施法的其他光環"
...
L["Show curable/removable auras"] = "顯示 可治癒/可驅散 光環"
...
L["%s member"] = "%s成員"
L["Solid color to use in the indicator, only used if you do not have use aura icon enabled."] = "標記使用單色，僅限於您沒有啟用光環圖標下使用。"
L["Sorting"] = "分類"
L["Sort method"] = "分類方式"
L["Sort order"] = "分類排列"
L["Soul shards"] = "靈魂碎片"
...
L["Stagger"] = "醉仙緩勁"
L["Stagger bar"] = "醉仙緩勁狀態條"
L["Stagger bar color when the staggered amount is <30% of your HP."] = "當你的生命值<30%時 醉仙緩勁狀態條的顏色"
L["Stagger bar color when the staggered amount is >30% of your HP."] = "當你的生命值>30%時 醉仙緩勁狀態條的顏色"
L["Stagger bar color when the staggered amount is >70% of your HP."] = "當你的生命值>70%時 醉仙緩勁狀態條的顏色"
...
L["The unit frames you see are examples, they are not perfect and do not show all the data they normally would.|n|nYou can hide them by locking them through /shadowuf or clicking the button below."] = "你看到的頭像僅是範例, 他們不是那麼完美並且不會顯示應該顯示的所有數據.|n|n你可以通過命令行 /shadowuf或點擊下面的按鈕鎖定來隱藏他們."
...
Handy if you want to know if a target has a Rejuvenation on them, but you also want to know if you were the one who casted the Rejuvenation.]=] ] = [=[這種顏色將用於如果顯示的指標是自己的，僅適用於不使用圖標時。
方便於如果你想知道目標身上已經有個回春術，但你也想知道是哪位施放了此回春術。]=]
...
L["This is a good guide on how to get started with programming in Lua, while you do not need to read the entire thing it is a helpful for understanding the basics of Lua syntax and API's."] = "這是一個如何開始Lua編程的很好的指南, 然而你並不需要閱讀整個事情, 它有助於了解Lua的語法和API的基礎知識."
...
L["Travel"] = "旅行"
L["Tree"] = "樹"
L["Turns this widget into a bar that can be resized and ordered just like health and power bars."] = "改變計量條的比重，可以調整排列就像生命條和能量條一樣。"
L["Unattackable hostile"] = "不可攻擊的敵對單位"
L["Unchecking this will completely disable aura indicators for %s."] = "取消勾選將會完全取消 %s 的光環指標。"
...
L["You can find more information on creating your own custom tags in the \"Help\" tab above."] = "在上面的\"說明\"標籤上你可以找到更多關於建立自訂標籤的資訊。"
...
L["You can override what aura is enabled on a per-class basis, note that if the aura is disabled through the main listing, then your class settings here will not matter."] = "您可以覆蓋每個職業上已啟用的光環設置，注意如果光環透過主要選單已經禁用， 那麼你這裡的職業設置將不受影響。"
...
L["You must restart Shadowed Unit Frames."] = "您必須重新啟動Shadowed Unit Frames."
