...
-- 要更改箭頭圖案，將下行中的 NeonRedArrow 替換為 AddOns > TargetNameplateIndicator > Textures 資料夾內的任何一個檔案名稱，不要加上副檔名。
CONFIG.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\NeonRedArrow"
...
CONFIG.OFFSET_X = 0                -- 箭頭圖案的水平位置 The x/y offset of the texture relative to the anchor point.
CONFIG.OFFSET_Y = 18               -- 箭頭圖案的垂直位置
