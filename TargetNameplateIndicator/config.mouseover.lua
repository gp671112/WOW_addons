local _, ns = ...
local MOUSEOVER_CONFIG = { SELF = {}, FRIENDLY = {}, HOSTILE = {} }
ns.MOUSEOVER_CONFIG = MOUSEOVER_CONFIG

----------------------------
-- START OF MOUSEOVER CONFIG --
----------------------------
...
-- Config variables that start with MOUSEOVER_CONFIG.SELF are used when mousing over yourself.
-- Config variables that start MOUSEOVER_CONFIG.FRIENDLY are used for friendly mouseovers.
-- Config variables that start with MOUSEOVER_CONFIG.HOSTILE are used for hostile mouseovers.

-------
-- This variable controls whether the texture is visible for your mouseover.
-------
MOUSEOVER_CONFIG.ENABLED = true						-- 啟用/停用所有滑鼠指向的箭頭圖案，true 代表啟用、false 代表停用。

-------
-- These variables control whether the indicator is visible for yourself and for friendly and hostile units.
-------

MOUSEOVER_CONFIG.SELF.ENABLED = true				-- 啟用/停用滑鼠指向自己的箭頭圖案

MOUSEOVER_CONFIG.FRIENDLY.ENABLED = true			-- 啟用/停用滑鼠指向友方的箭頭圖案

MOUSEOVER_CONFIG.HOSTILE.ENABLED = true				-- 啟用/停用滑鼠指向敵方的箭頭圖案
...
-- 要更改 "滑鼠指向自己" 個人資源條的箭頭圖案，將下行中的 NeonReticule 替換為 AddOns > TargetNameplateIndicator > Textures 資料夾內的任何一個檔案名稱，不要加上副檔名。
MOUSEOVER_CONFIG.SELF.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\whitearrow1"

-- 要更改 "滑鼠指向友方" 箭頭圖案，將下行中的 NeonGreenArrow 替換為 AddOns > TargetNameplateIndicator > Textures 資料夾內的任何一個檔案名稱，不要加上副檔名。
MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\greenarrow1"

-- 要更改 "滑鼠指向敵方" 箭頭圖案，將下行中的 NeonRedArrow 替換為 AddOns > TargetNameplateIndicator > Textures 資料夾內的任何一個檔案名稱，不要加上副檔名。
MOUSEOVER_CONFIG.HOSTILE.TEXTURE_PATH  = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\redarrow1"
...
MOUSEOVER_CONFIG.SELF.TEXTURE_HEIGHT = 50			-- 滑鼠指向自己箭頭圖案的大小
MOUSEOVER_CONFIG.SELF.TEXTURE_WIDTH  = 50

MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_HEIGHT = 50		-- 滑鼠指向友方箭頭圖案的大小
MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_WIDTH  = 50

MOUSEOVER_CONFIG.HOSTILE.TEXTURE_HEIGHT  = 50		-- 滑鼠指向敵方箭頭圖案的大小
MOUSEOVER_CONFIG.HOSTILE.TEXTURE_WIDTH   = 50


-- The opacity of the texture. 1 is fully opaque, 0 is transparent.
MOUSEOVER_CONFIG.SELF.OPACITY = 1					-- 滑鼠指向自己箭頭圖案的透明度

MOUSEOVER_CONFIG.FRIENDLY.OPACITY = 1				-- 滑鼠指向友方箭頭圖案的透明度

MOUSEOVER_CONFIG.HOSTILE.OPACITY = 1				-- 滑鼠指向敵方箭頭圖案的透明度
...
MOUSEOVER_CONFIG.SELF.TEXTURE_POINT = "BOTTOM"      -- The point of the texture that should be anchored to the nameplate.
MOUSEOVER_CONFIG.SELF.ANCHOR_POINT  = "TOP"         -- The point of the nameplate the texture should be anchored to.
MOUSEOVER_CONFIG.SELF.OFFSET_X = 0                  -- The x/y offset of the texture relative to the anchor point.
MOUSEOVER_CONFIG.SELF.OFFSET_Y = -10				-- 滑鼠指向自己箭頭圖案的 x/y 位置

MOUSEOVER_CONFIG.FRIENDLY.TEXTURE_POINT = "BOTTOM"  -- The point of the texture that should be anchored to the nameplate.
MOUSEOVER_CONFIG.FRIENDLY.ANCHOR_POINT  = "TOP"     -- The point of the nameplate the texture should be anchored to.
MOUSEOVER_CONFIG.FRIENDLY.OFFSET_X = 0              -- The x/y offset of the texture relative to the anchor point.
MOUSEOVER_CONFIG.FRIENDLY.OFFSET_Y = -10				-- 滑鼠指向友方箭頭圖案的 x/y 位置

MOUSEOVER_CONFIG.HOSTILE.TEXTURE_POINT = "BOTTOM"   -- The point of the texture that should be anchored to the nameplate.
MOUSEOVER_CONFIG.HOSTILE.ANCHOR_POINT  = "TOP"      -- The point of the nameplate the texture should be anchored to.
MOUSEOVER_CONFIG.HOSTILE.OFFSET_X = 0               -- The x/y offset of the texture relative to the anchor point.
MOUSEOVER_CONFIG.HOSTILE.OFFSET_Y = 5				-- 滑鼠指向敵方箭頭圖案的 x/y 位置

--------------------------
-- END OF MOUSEOVER CONFIG --
--------------------------
