...
local TidyPlatesInterfacePanel = PanelHelpers:CreatePanelFrame( "TidyPlatesInterfaceOptions", "Tidy血條", "Tidy血條" )
...
local NO_AUTOMATION = "不要自動切換"
local DURING_COMBAT = "戰鬥中顯示，戰鬥結束時隱藏"
local OUT_OF_COMBAT = "戰鬥中隱藏，戰鬥結束時顯示"
...
local ProfileList = {
	{ text = "傷害輸出", r = 1 , g =.1 , b = 0, value = "Damage" },
	{ text = "治療者", value = "Healer"},
	{ text = "坦克", value = "Tank"},
}
...
local function OnRefresh(panel)
	...
	panel.PrimaryProfileLabel:SetText(primarySpecName.. "專精角色:")
	panel.PrimaryThemeLabel:SetText(primarySpecName.. "外觀樣式主題:")

	panel.SecondaryProfileLabel:SetText(secondarySpecName.. "專精角色:")
	panel.SecondaryThemeLabel:SetText(secondarySpecName.. "外觀樣式主題:")
...
local function CreateTidyPlatesInterfacePanel(panel)
	...
	panel.Label:SetFont(STANDARD_TEXT_FONT, 26)
	...
	panel.Version:SetFont(STANDARD_TEXT_FONT, 18)
	...
	panel.PrimaryThemeLabel:SetText("主要天賦專精:")
	...
	panel.SecondaryThemeLabel:SetText("第二天賦專精:")
	...
	panel.ThemeLabel:SetText("外觀樣式主題")
...
-- [[
	...
	panel.PrimaryProfileLabel:SetText("主要天賦專精:")
	...
	panel.EditSecondaryProfile:SetText("編輯...")
	...
	panel.AutoShowEnemyLabel:SetText("敵方血條:")
	...
	BlizzOptionsButton:SetText("血條排列和顯示設定")

	-- Cast Bars
	panel.DisableCastBars = PanelHelpers:CreateCheckButton("TidyPlatesOptions_DisableCastBars", panel, "停用施法條")
	...
	-- CompatibilityMode
	panel.CompatibilityMode = PanelHelpers:CreateCheckButton("TidyPlatesOptions_CompatibilityMode", panel, "相容模式")
	...
	ResetButton:SetScript("OnClick", function()
		...
		if IsShiftKeyDown() then
			...
			OnRefresh(panel)
			ApplyThemeSettings()
			print(yellow.."正在重置設定 "..orange.."Tidy血條"..yellow.." 恢復為預設外觀樣式主題")
			print(yellow.."按住 "..blue.."Shift"..yellow.." 點滑鼠左鍵"..red.."重置設定"..yellow.."會清除儲存的設定，並且重新載入使用者介面。")
		end
