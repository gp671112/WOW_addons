...
local options = {
	...
	-- Font
	{
		...
		{ type = "Slider", var = "fontSizeDelta", label = L["Font Size Delta"], min = -10, max = 10, step = 1 },
	},
	-- Classify
	{
		[0] = L["Classify"],
	...
	-- Bar Types
	{
		...
		{ type = "Check", var = "healthBarClassColor", label = L["Class Colored Health Bar"], tip = L["This options colors the health bar in the same color as the player class"], y = 6 },
		{ type = "Color", var = "healthBarColor", label = L["Health Bar Color"], tip = L["The color of the health bar. Has no effect for players with the option above enabled"], y = 10 },
		...
		{ type = "Color", var = "manaBarColor", label = L["Mana Bar Color"], tip = L["The color of the mana bar"], y = 10 },
