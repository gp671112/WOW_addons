...
function mod:OnInitialize()
  ...
  ACD3:AddToBlizOptions("WorldQuestAssistant", L["WorldQuestAssistant"], nil, "config")
  ACD3:AddToBlizOptions("WorldQuestAssistant", L["Profiles"], L["WorldQuestAssistant"], "profiles")
...
function mod:CreateQuestGroup(questID)
  ...
  _G.C_LFGList.CreateListing(info.activityID, "", 0, 0, "", string.format(L["Created by World Quest Assistant #WQ:%s#%s#"], self.activeQuestID, self:HomeRealmType() or "NIL"), true, false, info.questID)
  isWQAGroup = true
  self:TurnOffRaidConvertWarning()
end
