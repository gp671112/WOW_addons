...
L["Ask To Join - Description"] = "When joining a group, should WQA show you a popup asking you to join or start a group?"
...
L["Created by World Quest Assistant #WQ:%s#%s#"] = true
L["WorldQuestAssistant"] = true