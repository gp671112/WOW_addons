...
L["WQGF_FRAME_FOUND_GROUPS"] = "Encontrado %d grupo(s). Clique no botão para alistar."
...
L["WQGF_KICK_TOOLTIP"] = "Chute todos os jogadores que estão muito longe"
L["WQGF_LEADERS_BL_CLEARED"] = "A lista negra de lideres foi limpa."
L["WQGF_LEAVE"] = "Sair"
L["WQGF_MEMBER_TOO_FAR_AWAY"] = "O membro do grupo %s esta %s metros de distancia. Use o botão de chute automático para remove-lo do grupo."
L["WQGF_NEW_ENTRY_CREATED"] = "Um novo grupo foi criada para |c00bfffff%s|c00ffffff."
L["WQGF_NO"] = "Não"
L["WQGF_NO_APPLICATIONS_ANSWERED"] = "Nenhum de seus alistamentos para |c00bfffff%s|c00ffffff respondeu a tempo. Tentando achar um novo grupo..."
L["WQGF_NO_APPLY_BLACKLIST"] = "Você não se alistou para o grupo %d pois o líder esta na Lista Negra  |c00bfffff/wqgf unbl |c00ffffffpara limpar a Lista."
